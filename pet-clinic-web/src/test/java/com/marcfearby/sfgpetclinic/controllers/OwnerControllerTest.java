package com.marcfearby.sfgpetclinic.controllers;
...
class OwnerControllerTest {
    ...
    void setUp() {
        owners = new HashSet<>();
        owners.add(Owner.builder().id(1L).firstName("Marc").build());
        owners.add(Owner.builder().id(2L).firstName("Simon").build());
